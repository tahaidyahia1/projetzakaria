          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Chez <span className="font-semibold text-primary">CAP2A Consulting</span>, nous sommes convaincus que toute organisation peut atteindre un niveau d’excellence durable lorsqu’elle bénéficie d’un accompagnement adapté et d’une montée en compétence continue. Forts de plus de 20 années d’expérience dans les systèmes de management , nous aidons les organismes publics et privés à structurer, améliorer et pérenniser leurs démarches qualité.
