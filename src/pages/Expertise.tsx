      ...
      sections: [
        {
          ...
          items: [
            ...
            'Mise en place du système d’évaluation de la conformité',
                ...
                'Préparation à l’accréditation',
                'Formation des inspecteurs',
                'Exigences ISO 17020 et principes d’impartialité/indépendance.',
              ...
              >
                <div className="relative bg-white rounded-3xl shadow-lg hover:shadow-3d transition-all duration-500 hover:-translate-y-2 overflow-hidden h-full">
                  ...
                  <div className="relative p-8">
                    ...
                    <h3 className="font-display font-bold text-2xl text-gray-900 mb-4 group-hover:text-primary transition-colors whitespace-nowrap">
                      {service.title}
                    </h3>
